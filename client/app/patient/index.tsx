...
export default function Dashboard() {
  ...
  const sections = [
    { title: "Appointments", route: "/patient/appointments", icon: "calendar-outline", color: ["#34d399", "#059669"] },
    ...
    { title: "Medical Records", route: "/patient/MedicalRecords", icon: "document-text-outline", color: ["#a78bfa", "#6d28d9"] },
  ];
